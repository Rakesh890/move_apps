...
class MovieDetailModel extends MovieDetailEntity with EquatableMixin{
  final bool? adult;
...
class BelongsToCollection extends BelongsToCollectionEntity with EquatableMixin{
  final int? id;
  final String? name;
  final String? posterPath;
  final String? backdropPath;
...
class Genres extends GenresEntity with EquatableMixin{
  final int? id;
  final String? name;
...
class ProductionCompanies extends ProductionCompaniesEntity with EquatableMixin{
  final int? id;
...
class ProductionCountries  extends ProductionCountriesEntity with EquatableMixin{
...
class SpokenLanguages extends SpokenLanguagesEntity with EquatableMixin{
